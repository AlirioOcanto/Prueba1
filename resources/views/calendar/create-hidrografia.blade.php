        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class=" overflow-hidden shadow-xl sm:rounded-lg p-3">
                <div class="flex items-center justify-center">
                    <h2 class="text-3xl font-semibold">Agendar una Cita de Hidrografía a un Usuario</h2>
                </div>
                <div class="my-5">
                    <div class="relative overflow-x-auto ">
                        <form action="{{ route('hydrography.reunion.store') }}" method="POST" >
                            @csrf
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="user_name" id="user_name" class="form-input rounded-lg w-full" />
                                    {{-- show error --}}
                                    @error('user_name')
                                 ...
                                 <div class="mb-4">
                                    ...
                                    <select name="hydrographies_id" id="brand" class="form-input rounded-md shadow-sm mt-1 block w-full">
                                        ...
                                        @foreach ($products as $brand)
                                            <option value="{{ $brand->id }}">{{ $brand->type }} </option>
                                        @endforeach
                                    </select>
                                    {{-- show error --}}
                                    @error('sales_id')
