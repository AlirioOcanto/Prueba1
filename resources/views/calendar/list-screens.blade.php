            ...
            @foreach ($users as $user)
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <td class="px-6 py-4 text-right flex items-center gap-2">
                        <a href="{{ route('calendar.screens.show', $user ) }}" class="font-medium text-yellow-600 dark:text-yellow-500 hover:underline">Ver</a>
                        <a href="{{ route('calendar.screens.edit', $user) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
