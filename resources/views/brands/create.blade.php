<x-app-layout>
    <x-slot name="header">
       ...
       <div class="mx-auto container max-w-7xl my-5 sm:px-6 lg:px-8 ">
        <a href="{{ route('brands.index') }}" class="text-blue-500 font-semibold">Ver todas las marcas de vehículos</a>
    </div>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class=" overflow-hidden shadow-xl sm:rounded-lg p-3">
                <div class="flex items-center justify-center">
                    <h2 class="text-3xl font-semibold">Crear un nueva Marca</h2>
                </div>
                <div class="my-5">
